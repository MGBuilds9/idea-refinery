...
export default function Sidebar({ activeView, onViewChange }) {
  ...
  return (
    <div className="w-64 bg-[var(--color-bg-surface)] border-r border-[var(--glass-border)] flex flex-col h-screen fixed left-0 top-0 z-50 animate-slide-in-left backdrop-blur-md">
      {/* Logo Area */}
