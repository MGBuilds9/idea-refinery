...
// Optimized: Wrapped in React.memo to prevent unnecessary re-renders of all questions when typing in one
const QuestionItem = memo(({ index, question, answer, onChange }) => {
  return (
