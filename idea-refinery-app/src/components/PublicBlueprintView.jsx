...
export default function PublicBlueprintView({ blueprintId }) {
    ...
    return (
      <div className="min-h-screen bg-[#09090b] flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-zinc-400 font-mono text-sm">Loading blueprint...</p>
        </div>
      </div>
    );
  }
    ...
    return (
      <div className="min-h-screen bg-[#09090b] flex items-center justify-center p-4">
        <div className="text-center max-w-md">
          ...
          <h1 className="text-2xl text-white font-sans font-semibold mb-2">Blueprint Not Found</h1>
          <p className="text-zinc-500 font-mono text-sm mb-6">{error}</p>
          <a
            href="/"
  ...
  return (
    <div className="min-h-screen bg-[#09090b] text-white">
      {/* Header */}
      <header className="border-b border-white/10 bg-[#131316]/80 backdrop-blur-sm sticky top-0 z-10">
        <div className="max-w-5xl mx-auto px-6 py-4 flex items-center justify-between">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h1 className="text-lg font-sans font-semibold text-white line-clamp-1">
                {blueprint.title}
              </h1>
